    ...
    <div className="data-page-stack">
      ...
      <DataAccordion
        ...
        <div className={`data-detail-rows ${detailOpen ? "is-open" : ""}`}>
          ...
          <div className="data-detail-item">
            <span>Read-model engine</span>
            <span>{overview?.storageEngine.activeEngine ?? "dexie"}</span>
          </div>
          <div className="data-detail-item">
            <span>Migration state</span>
            <span>{overview?.storageEngine.migrationState ?? "idle"}</span>
          </div>
          <div className="data-detail-item">
          ...
          {overview?.storageEngine.lastError ? (
            <p className="data-detail-note">
              SQLite read-model fallback active:{" "}
              {overview.storageEngine.lastError}
            </p>
          ) : null}
          <p className="data-detail-note">
